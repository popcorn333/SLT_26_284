...
gen=/mnt/parscratch/users/acp23xt/private/DTDM_sgmse/one-shot/one-shot_inf/model.masking.a:0.2/test/converted/Epoch_595
out=/mnt/parscratch/users/acp23xt/private/DTDM_sgmse/one-shot/one-shot_inf/model.masking.a:0.2/test/metrics
